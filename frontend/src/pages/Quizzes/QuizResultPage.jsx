...
const QuizResultPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-lg p-10 mt-6">
        <div className="text-center space-y-6">

          <div className="inline-flex items-center justify-center w-15 h-15 rounded-2xl bg-emerald-100">
        ...
        {detailedResults.map((result, index) => {
          ...
          return (
            ...
            >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {isCorrectOption && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 border border-emerald-200 rounded-full text-xs font-medium text-emerald-700">
                          ...
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-rose-100 border border-rose-200 rounded-full text-xs font-medium text-rose-700">
              ...
              {/* Explanation */}
              {result.explanation && (
                <div className="p-4 bg-gradient-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-lg">
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${quiz.document._id}`}>
          <button className="group relative px-8 h-12 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-semibold shadow-lg transition-all hover:scale-105">
